 ...
 * 
 */
@WebServiceClient(name = "SoapService", targetNamespace = "http://package1/", wsdlLocation = "http://localhost:8080/EnterpriseApplication1-war/SoapService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVICE_QNAME = new QName("http://package1/", "SoapService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/EnterpriseApplication1-war/SoapService?WSDL");
    ...
    public SoapService getSoapServicePort() {
        return super.getPort(new QName("http://package1/", "SoapServicePort"), SoapService.class);
    }
    ...
    public SoapService getSoapServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://package1/", "SoapServicePort"), SoapService.class, features);
    }
